...
class ParallelLineTool : public CadTool
{
    Q_OBJECT
public:
...
private:
    ...
    bool getEntityLineParams(const CadEntity* entity, QPointF& p1, QPointF& p2, QPointF& dirVector, QPointF& normalVector) const;
