...
public:
    ...
    void setPerpendicularSnapEnabled(bool enabled) { m_perpendicularSnapEnabled = enabled; }
    void setConstructionLineSnapEnabled(bool enabled) { m_constructionLineSnapEnabled = enabled; }
...
private:
    ...
    bool m_perpendicularSnapEnabled = true;
    bool m_constructionLineSnapEnabled = true;
};